...
var bookingHours = GetUserTypicalBookingHours(userId); // e.g., [6, 7, 17, 18, 19]
...
```csharp
// Score classes in parallel for large candidate sets
...
This recommendation system demonstrates sophisticated personalization thinking suitable for a senior engineering role! 🚀
